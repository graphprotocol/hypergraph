        ...
        <div className="flex h-6 shrink-0 items-center">
          <div className="group grid size-4 grid-cols-1">
            <HeadlessCheckbox
              ...
              className="group col-start-1 row-start-1 appearance-none rounded-sm border border-gray-300 dark:border-slate-800 bg-white dark:bg-slate-700 checked:border-indigo-600 data-[checked]:border-indigo-600 checked:bg-indigo-600 data-[checked]:bg-indigo-600 indeterminate:border-indigo-600 indeterminate:bg-indigo-600 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600 disabled:border-gray-300 disabled:bg-gray-100 disabled:checked:bg-gray-100 forced-colors:appearance-auto size-5 inline-flex items-center justify-center"
            >
              <CheckIcon
                className="group-data-checked:opacity-100 stroke-white text-white opacity-0 size-4"
                aria-hidden="true"
              />
            </HeadlessCheckbox>
          </div>
        </div>
        <div className="text-sm/6 mt-1">
